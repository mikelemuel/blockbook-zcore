...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ZCore features */
        {"zcore", "masternode", &masternode, true, true, false},
        {"zcore", "listmasternodes", &listmasternodes, true, true, false},
        {"zcore", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zcore", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zcore", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"zcore", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"zcore", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"zcore", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zcore", "masternodedebug", &masternodedebug, true, true, false},
        {"zcore", "startmasternode", &startmasternode, true, true, false},
        {"zcore", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zcore", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zcore", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zcore", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zcore", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zcore", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zcore", "mnbudget", &mnbudget, true, true, false},
        {"zcore", "preparebudget", &preparebudget, true, true, false},
        {"zcore", "submitbudget", &submitbudget, true, true, false},
        {"zcore", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zcore", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zcore", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zcore", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zcore", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zcore", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zcore", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zcore", "checkbudgets", &checkbudgets, true, true, false},
        {"zcore", "mnsync", &mnsync, true, true, false},
        {"zcore", "spork", &spork, true, true, false},
        {"zcore", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"addressindex","getaddressmempool", &getaddressmempool,false,false, true},
        {"addressindex", "getaddressutxos", &getaddressutxos, false, false, true},
        ...
        {"zerocoin", "getzzcrseed", &getzzcrseed, false, false, true},
        {"zerocoin", "setzzcrseed", &setzzcrseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzzcr", &searchdzzcr, false, false, true},
        {"zerocoin", "dzzcrstate", &dzzcrstate, false, false, true}
...
{
    return "> zcore-cli " + methodname + " " + args + "\n";
}
