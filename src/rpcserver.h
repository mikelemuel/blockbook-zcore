...
extern UniValue setzzcrseed(const UniValue& params, bool fHelp);
extern UniValue getzzcrseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzzcr(const UniValue& params, bool fHelp);
extern UniValue dzzcrstate(const UniValue& params, bool fHelp);
